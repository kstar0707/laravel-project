                        ...
                        <table id="myTable" class="table table-borderless table-striped ">
                            <thead style="background-color: black">
                                <tr>
                                    ...
                                    <th class="text-center">自分ボードID</th>
                                    <th class="text-center">応答ボード ニックネーム</th>
                            ...
                            <tbody>
                                @foreach($resboard as  $item => $row)
                                <tr>
                                    <td class="text-center">{{ $item +1 }}</td>
                                    <td class="text-center">{{ $row->id }}</td>
                                    <td class="text-center">{{ $row->user_nickname }}</td>
                                    <td class="text-center">{{ $row->res_board_content }}</td>
